...
//  Firebase_demo
//
//  Created by Hoang Dinh Huy on 11/24/19.
...
extension UITextField {
    ...
    func isDatePickerTextField(minimumDate min: Date? = nil, maximumDate max: Date? = Date(), dateFormat format: String? = "dd/MM/yyyy") {
        ...
        if let view = self.superview {
            ...
            let todayBtn = UIBarButtonItem(title: "Today", style: .plain, target: self, action: #selector(tappedToolBarBtn))
